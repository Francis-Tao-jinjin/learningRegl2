...
container.addEventListener('click', function (e) {
  ...
  var position = clientPos2normalPos(event.clientX, event.clientY);
  add_point(position[0], position[1]);
});

function clientPos2normalPos(position) {
  var x = (position[0] - window.innerWidth / 2) / (window.innerWidth / 2);
  var y = (position[1] - window.innerHeight / 2) / (window.innerHeight / 2);
  return [x, y];
}
...
},{"regl":3}],2:[function(require,module,exports){
'use strict';

require('./lessons/2_2');

},{"./lessons/2_2":1}],3:[function(require,module,exports){
